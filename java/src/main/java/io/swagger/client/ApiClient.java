...
public class ApiClient {
    ...
    private String basePath = "http://barrydomain.com/virts/Adam/NewTestApi/1.0.0";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://barrydomain.com/virts/Adam/NewTestApi/1.0.0
